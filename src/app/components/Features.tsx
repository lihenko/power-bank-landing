...
export default function Features({ eyebrow, title, description, items }: FeaturesConfig) {
  return (
    <section id="features" className="bg-slate-50 py-20">
      <div className="mx-auto max-w-7xl px-4">
        <div className="max-w-3xl">
          {eyebrow && <p className="mb-3 text-sm text-slate-500">{eyebrow}</p>}
          <h2 className="mt-6 text-4xl font-black text-slate-900">{title}</h2>
          {description && (
