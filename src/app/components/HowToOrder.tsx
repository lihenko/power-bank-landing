const STEPS = [
  ...
  {
    title: "Підтвердження та передоплата",
    description: "Менеджер зв'яжеться з вами для підтвердження. Для підтвердження замовлення внесіть передплату.",
  },
  {
    title: "Відправимо",
  ...
  {
    title: "Доплатіть при отриманні",
    description: "Огляньте товар у відділенні та доплатіть залишок суми.",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-4">
        <div className="max-w-3xl">
          ...
          <p className="mt-5 text-lg leading-8 text-slate-600">
            Оформлення займає менше хвилини.
          </p>
        </div>
